...
namespace FoodLink.Infrastructure.Migrations
{
    ...
    [Migration("20260625175929_ChangeDateTimeAttributeIAuditableEntity")]
    partial class ChangeDateTimeAttributeIAuditableEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodLink.Domain.Entities.Donation", b =>
                {
                    b.HasOne("FoodLink.Domain.Entities.Profiles.BusinessProfile", "BusinessProfile")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodLink.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("FoodLink.Domain.Entities.Donation", "Donation")
                        .WithMany()
                        .HasForeignKey("DonationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
